    ...
    <footer className="bg-gradient-to-r from-[#0094cf1a] to-[#0094cf18]">
      <Container className="">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 py-16 lg:py-20 2xl:py-24">
          ...
          {/* section two */}
          <div className="">
            <h4 className="text-[#010937] font-bold mb-4 uppercase text-[18px]">
              Important Links
            </h4>
            <div className="space-y-1">
              {/* <p className="text-[#010937] font-medium cursor-pointer">
                  Home
                </p> */}
              <p className="text-[#010937] font-medium cursor-pointer">
                Popular Fish
          ...
          {/* section three */}
          <div className="">
            <h4 className="text-[#010937] font-bold mb-4 text-[18px]">
              ONLINE RESERVATION
            </h4>
        ...
        <div>
          <small className="flex justify-center pb-4">
